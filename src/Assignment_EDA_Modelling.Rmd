...
author: Bugra Sipahioglu (14318334), Christos Georghiou (16072766), Despoina Delipalla (16324897), Jeremi Wasilewski (14271028)
...
accuracy_ets <- accuracy(fc_ets_eval, ts_evaluation)
accuracy_ets
```
...
rmse_test <- sqrt(mean(e_te^2, na.rm = TRUE))
rmse_test
...
best_param_df <- as.list(best_param_df[1, ])
...
BUGRA: Extract train and validation loss to observe whether under- or
...
learning_curve_tuned <- data.frame(
